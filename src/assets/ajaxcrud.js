 ...
 * Ajax Crud 
 * =================================
 * Use for ansori/yii2-hideshowcolumngridview extension
...
$(document).ready(function () {
    ...
    if ($('#ajaxCrubModal').length > 0 && $('#hideshowcolumngridviewModal').length == 0) {
        modal = new ModalRemote('#ajaxCrubModal');
    } else {
        modal = new ModalRemote('#hideshowcolumngridviewModal');
    }
